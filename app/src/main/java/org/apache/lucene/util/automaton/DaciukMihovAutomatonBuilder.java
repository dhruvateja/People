 ...
 * @see BasicAutomata#makeStringUnion(java.util.Collection)
 */
final class DaciukMihovAutomatonBuilder {
  ...
  /**
   * Previous sequence added to the automaton in {@link #add(org.apache.lucene.util.CharsRef)}.
   */
  ...
  /**
   * Build a minimal, deterministic automaton from a sorted list of {@link org.apache.lucene.util.BytesRef} representing

...
public class PackedInts {
   ...
   * {@link PackedInts#getWriterNoHeader(org.apache.lucene.store.DataOutput, Format, int, int, int)}.
   *
   ...
   * @see PackedInts#getWriterNoHeader(org.apache.lucene.store.DataOutput, Format, int, int, int)
   * @lucene.internal
   */
  ...
  /**
   * Construct a direct {@link Reader} from an {@link org.apache.lucene.store.IndexInput}. This method
   * is useful to restore data from streams which have been created using
   * {@link PackedInts#getWriter(org.apache.lucene.store.DataOutput, int, int, float)}.
   * </p><p>
   * The returned reader will have very little memory overhead, but every call
   * to {@link Reader#get(int)} is likely to perform a disk seek.
   *
   ...
   * @return             a Writer
   * @see PackedInts#getReaderIteratorNoHeader(org.apache.lucene.store.DataInput, Format, int, int, int, int)
   * @see PackedInts#getReaderNoHeader(org.apache.lucene.store.DataInput, Format, int, int, int)
   * @lucene.internal
   */
   ...
   * {@link #getWriterNoHeader(org.apache.lucene.store.DataOutput, Format, int, int, int)}.
   * </p><p>

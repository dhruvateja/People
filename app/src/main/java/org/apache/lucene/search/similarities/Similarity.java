 ...
 * <p>
 * <a name="indextime"/>
 * At indexing time, the indexer calls {@link #computeNorm(org.apache.lucene.index.FieldInvertState, org.apache.lucene.index.Norm)}, allowing
 ...
 * combination of {@link org.apache.lucene.search.CollectionStatistics#sumTotalTermFreq()} and
 * {@link org.apache.lucene.search.CollectionStatistics#maxDoc()} or {@link org.apache.lucene.search.CollectionStatistics#docCount()},
 * depending upon whether the average should reflect field sparsity.
 * <p>
 * Additional scoring factors can be stored in named
 * <code>*DocValuesField</code>s (such as {@link
 * ByteDocValuesField} or {@link org.apache.lucene.document.FloatDocValuesField}), and accessed
 ...
 * <ol>
 *   <li>The {@link #computeWeight(float, org.apache.lucene.search.CollectionStatistics, TermStatistics...)} method is called a single time,
 *       allowing the implementation to compute any statistics (such as IDF, average document length, etc)
 *       across <i>the entire collection</i>. The {@link TermStatistics} and {@link org.apache.lucene.search.CollectionStatistics} passed in
 ...
 *       and any top-level boosts (e.g. from enclosing {@link org.apache.lucene.search.BooleanQuery}s).
 *   <li>For each segment in the index, the Query creates a {@link #exactSimScorer(SimWeight, org.apache.lucene.index.AtomicReaderContext)}
 *       (for queries with exact frequencies such as TermQuerys and exact PhraseQueries) or a
 *       {@link #sloppySimScorer(SimWeight, org.apache.lucene.index.AtomicReaderContext)} (for queries with sloppy frequencies such as
 *       SpanQuerys and sloppy PhraseQueries). The score() method is called for each matching document.
 * </ol>
 * <p>
 * <a name="explaintime"/>
 * When {@link org.apache.lucene.search.IndexSearcher#explain(org.apache.lucene.search.Query, int)} is called, queries consult the Similarity's DocScorer for an
 * explanation of how it computed its score. The query passes in a the document id and an explanation of how the frequency
 * was computed.
 *
 * @see org.apache.lucene.index.IndexWriterConfig#setSimilarity(Similarity)
 * @see org.apache.lucene.search.IndexSearcher#setSimilarity(Similarity)
 * @lucene.experimental
 */
public abstract class Similarity {
   ...
   * state and set that value to the given {@link org.apache.lucene.index.Norm}.
   *
   ...
   * @param weight collection information from {@link #computeWeight(float, org.apache.lucene.search.CollectionStatistics, TermStatistics...)}

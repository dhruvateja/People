...
public class BM25Similarity extends Similarity {
   ...
   * </pre>
   *
   * Note that {@link org.apache.lucene.search.CollectionStatistics#maxDoc()} is used instead of
   * {@link org.apache.lucene.index.IndexReader#numDocs() IndexReader#numDocs()} because also
   * {@link org.apache.lucene.search.TermStatistics#docFreq()} is used, and when the latter
   * is inaccurate, so is {@link org.apache.lucene.search.CollectionStatistics#maxDoc()}, and in the same direction.
   * In addition, {@link org.apache.lucene.search.CollectionStatistics#maxDoc()} is more efficient to compute
   *   

...
public abstract class PerDocProducer implements Closeable {
  ...
  /**
   * Returns {@link org.apache.lucene.index.DocValues} for the current field.
   *
   * @param field
   *          the field name
   * @return the {@link org.apache.lucene.index.DocValues} for this field or <code>null</code> if not
   *         applicable.

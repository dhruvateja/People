...
public abstract class PerDocProducerBase extends PerDocProducer {
  ...
  /** Returns the comparator used to sort {@link org.apache.lucene.util.BytesRef} values. */
  ...
  /**
   * Loads a {@link org.apache.lucene.index.DocValues} instance depending on the given {@link org.apache.lucene.index.DocValues.Type}.
   * Codecs that use different implementations for a certain {@link org.apache.lucene.index.DocValues.Type} can
   * simply override this method and return their custom implementations.
   *
   * @param docCount
   *          number of documents in the segment
   * @param dir
   *          the {@link org.apache.lucene.store.Directory} to load the {@link org.apache.lucene.index.DocValues} from
   * @param id
   *          the unique file ID within the segment
   * @param type
   *          the type to load
   * @return a {@link org.apache.lucene.index.DocValues} instance for the given type
   * @throws java.io.IOException
   *           if an {@link java.io.IOException} occurs
   * @throws IllegalArgumentException
   *           if the given {@link org.apache.lucene.index.DocValues.Type} is not supported
   */

...
public abstract class DocValuesWriterBase extends PerDocConsumer {
  ...
  /** {@link org.apache.lucene.store.IOContext} to use when writing files. */
   ...
   * org.apache.lucene.util.packed.PackedInts#FAST}.
  ...
  /** Returns the {@link org.apache.lucene.store.Directory} that files should be
   *  written to. */
  ...
  /** Returns the comparator used to sort {@link org.apache.lucene.util.BytesRef}
   *  values. */

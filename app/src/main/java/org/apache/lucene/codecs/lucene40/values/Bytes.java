...
public final class Bytes {
   ...
   * @param sortComparator {@link org.apache.lucene.util.BytesRef} comparator used by sorted variants.
   *        If <code>null</code> {@link org.apache.lucene.util.BytesRef#getUTF8SortedAsUnicodeComparator()}
   *        is used instead
   * @param bytesUsed
   *          an {@link java.util.concurrent.atomic.AtomicLong} instance to track the used bytes within the
   ...
   *          docvalues of type {@link org.apache.lucene.index.DocValues.Type#BYTES_FIXED_SORTED} and
   *          {@link org.apache.lucene.index.DocValues.Type#BYTES_VAR_SORTED}.
   * @param context I/O Context
   * @return a new {@link Writer} instance
   * @see org.apache.lucene.util.packed.PackedInts#getReader(org.apache.lucene.store.DataInput)
   */
  ...
  /**
   * Creates a new {@link org.apache.lucene.index.DocValues} instance that provides either memory
   * resident or iterative access to a per-document stored <tt>byte[]</tt>
   * value. The returned {@link org.apache.lucene.index.DocValues} instance will be initialized without
   * consuming a significant amount of memory.
   *
   * @param dir
   *          the directory to load the {@link org.apache.lucene.index.DocValues} from.
   * @param id
   *          the file ID in the {@link org.apache.lucene.store.Directory} to load the values from.
   * @param mode
   ...
   *        If <code>null</code> {@link org.apache.lucene.util.BytesRef#getUTF8SortedAsUnicodeComparator()}
   *        is used instead
   * @return an initialized {@link org.apache.lucene.index.DocValues} instance.
  ...
  static abstract class BytesReaderBase extends DocValues {
    ...
    /**
     * clones and returns the data {@link org.apache.lucene.store.IndexInput}
     */
    ...
    /**
     * clones and returns the indexing {@link org.apache.lucene.store.IndexInput}
     */

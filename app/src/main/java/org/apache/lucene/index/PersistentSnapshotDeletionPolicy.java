 ...
 * are persisted in a {@link org.apache.lucene.store.Directory} and are committed as soon as
 * {@link #snapshot(String)} or {@link #release(String)} is called.
 * <p>
 * <b>NOTE:</b> this class receives a {@link org.apache.lucene.store.Directory} to persist the data into
...
public class PersistentSnapshotDeletionPolicy extends SnapshotDeletionPolicy {
  ...
  /**
   * Reads the snapshots information from the given {@link org.apache.lucene.store.Directory}. This
   ...
   * @param dir
   *          the {@link org.apache.lucene.store.Directory} which will be used to persist the snapshots
   *          information.
   * @param mode

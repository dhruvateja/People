 ...
 * internal data-structure to the {@link IndexWriter}s {@link org.apache.lucene.store.Directory}.
 * <p>
 ...
 * {@link FlushPolicy}, the information provided via {@link org.apache.lucene.index.DocumentsWriterPerThreadPool.ThreadState} and
 ...
 *
 * @see org.apache.lucene.index.DocumentsWriterPerThreadPool.ThreadState
...
abstract class FlushPolicy implements Cloneable {
   ...
   * the given {@link org.apache.lucene.index.DocumentsWriterPerThreadPool.ThreadState} is non-null.
   * <p>
   ...
   * thread holds the lock on the given {@link org.apache.lucene.index.DocumentsWriterPerThreadPool.ThreadState}
   */
  public abstract void onDelete(DocumentsWriterFlushControl control,
      ThreadState state);

  /**
   * Called for each document update on the given {@link org.apache.lucene.index.DocumentsWriterPerThreadPool.ThreadState}'s
  ...
  /**
   * Called for each document addition on the given {@link org.apache.lucene.index.DocumentsWriterPerThreadPool.ThreadState}s
   * {@link DocumentsWriterPerThread}.
   * <p>
  ...
  /**
   * Returns the current most RAM consuming non-pending {@link org.apache.lucene.index.DocumentsWriterPerThreadPool.ThreadState} with

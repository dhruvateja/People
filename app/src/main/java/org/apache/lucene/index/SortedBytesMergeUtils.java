...
public final class SortedBytesMergeUtils {
   ...
   * target sorted source where the currently merged {@link org.apache.lucene.util.BytesRef} instance
   * should be stored at.
   */
  public static interface BytesRefConsumer {

    /**
     * Consumes a single {@link org.apache.lucene.util.BytesRef}. The provided {@link org.apache.lucene.util.BytesRef}
     * instances are strictly increasing with respect to the used
     * {@link java.util.Comparator} used for merging
     *
     * @param ref
     *          the {@link org.apache.lucene.util.BytesRef} to consume
     * @param ord
     *          the ordinal of the given {@link org.apache.lucene.util.BytesRef} in the merge target
     * @param offset
     *          the byte offset of the given {@link org.apache.lucene.util.BytesRef} in the merge
     *          target
  ...
  /**
   * A simple {@link BytesRefConsumer} that writes the merged {@link org.apache.lucene.util.BytesRef}
   * instances sequentially to an {@link org.apache.lucene.store.IndexOutput}.
   */
  ...
  /**
   * {@link SortedSourceSlice} represents a single {@link org.apache.lucene.index.DocValues.SortedSource} merge candidate.

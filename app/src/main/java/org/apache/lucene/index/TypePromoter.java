 ...
 * {@link org.apache.lucene.index.DocValues.Type} and {@link #getValueSize()}
 *
 * @lucene.internal
 */
class TypePromoter {
   ...
   *
   * @param type
   *          the {@link org.apache.lucene.index.DocValues.Type} this promoter represents
   *
   * @param flags
   *          the promoters flags
   * @param valueSize
  ...
  /**
   * Returns the {@link org.apache.lucene.index.DocValues.Type} of this {@link TypePromoter}
   *
   * @return the {@link org.apache.lucene.index.DocValues.Type} of this {@link TypePromoter}
   */
  public Type type() {
    return type;
  }
   ...
   *
   * @param type
   *          the {@link org.apache.lucene.index.DocValues.Type} to create the promoter for
   * @param valueSize

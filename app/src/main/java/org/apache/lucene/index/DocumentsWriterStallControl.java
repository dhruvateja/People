 ...
 * {@link org.apache.lucene.index.DocumentsWriterPerThreadPool.ThreadState}s in {@link DocumentsWriterPerThreadPool} is exceeded.
 * Once flushing catches up and the number of flushing DWPT is equal or lower
 * than the number of active {@link org.apache.lucene.index.DocumentsWriterPerThreadPool.ThreadState}s threads are released and can
 * continue indexing.
 */

...
public abstract class FilteredTermsEnum extends TermsEnum {
  ...
  protected static enum AcceptStatus {
    ...
    YES,
    /** Accept the term and advance ({@link FilteredTermsEnum#nextSeekTerm(org.apache.lucene.util.BytesRef)})
     * to the next term. */
    YES_AND_SEEK,
    /** Reject the term and position the enum at the next term. */
    NO,
    /** Reject the term and advance ({@link FilteredTermsEnum#nextSeekTerm(org.apache.lucene.util.BytesRef)})
     * to the next term. */
    NO_AND_SEEK,

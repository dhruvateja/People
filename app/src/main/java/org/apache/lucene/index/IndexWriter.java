...
/**
  ...
  <p>The {@link org.apache.lucene.index.IndexWriterConfig.OpenMode} option on
  {@link IndexWriterConfig#setOpenMode(org.apache.lucene.index.IndexWriterConfig.OpenMode)} determines
  whether a new index is created, or whether an existing index is
  opened. Note that you can open an index with {@link org.apache.lucene.index.IndexWriterConfig.OpenMode#CREATE}
  even while readers are using the index. The old readers will
  continue to search the "point in time" snapshot they had opened,
  and won't see the newly created index until they re-open. If
  {@link org.apache.lucene.index.IndexWriterConfig.OpenMode#CREATE_OR_APPEND} is used IndexWriter will create a
  new index if there is not already an index at the provided path
  and otherwise open the existing index.</p>

  <p>In either case, documents are added with {@link #addDocument(Iterable)
  addDocument} and removed with {@link #deleteDocuments(Term)} or {@link
  #deleteDocuments(org.apache.lucene.search.Query)}. A document can be updated with {@link
  ...
  flushed to the {@link org.apache.lucene.store.Directory} (during the above method
  ...
  {@link org.apache.lucene.store.LockObtainFailedException}. The {@link org.apache.lucene.store.LockObtainFailedException}
...
public class IndexWriter implements Closeable, TwoPhaseCommit {
   ...
   * org.apache.lucene.store.AlreadyClosedException} if this IndexWriter has been
   * closed.
   * @throws org.apache.lucene.store.AlreadyClosedException if this IndexWriter is closed
   */
  ...
  */
   ...
   * {@link #prepareFlushedSegment(org.apache.lucene.index.DocumentsWriterPerThread.FlushedSegment)} to obtain the
   ...
   *
   * <p>
   * <b>NOTE:</b> the index in each {@link org.apache.lucene.store.Directory} must not be
   ...
   * {@link org.apache.lucene.store.Directory} up to 2X the sum of all input indexes
   ...
   * {@link DirectoryReader#open(org.apache.lucene.store.Directory, int)}.
   *
   * <p>
   ...
   * href="#OOME">above</a> for details.</p>
   *
   * @see #prepareCommit(java.util.Map) */
   ...
   *
   *  <p>You can also just call {@link #commit(java.util.Map)} directly
   ...
   *  calls {@link #prepareCommit(java.util.Map)} (if you didn't

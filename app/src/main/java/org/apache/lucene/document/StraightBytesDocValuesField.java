 ...
 * <p>
 * Field that stores
 * a per-document {@link org.apache.lucene.util.BytesRef} value.  The values are
 ...
 *
 * @see org.apache.lucene.index.DocValues
 * */
...
public class StraightBytesDocValuesField extends Field {
   ...
   * <p>
   * This calls
   * {@link StraightBytesDocValuesField#StraightBytesDocValuesField(String, org.apache.lucene.util.BytesRef, boolean)

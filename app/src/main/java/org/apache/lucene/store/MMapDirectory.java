 ...
 * On 32 bit platforms also consult {@link #MMapDirectory(java.io.File, LockFactory, int)}
 ...
 * to {@link MMapDirectory} will throw a {@link java.nio.channels.ClosedChannelException}.
 * </p>
 */
public class MMapDirectory extends FSDirectory {
   ...
   * @see #MMapDirectory(java.io.File, LockFactory, int)
   */
